...
public:
    ...
    static void drawFullUI(Adafruit_ST7735 &tft, const SpotifyTrackState &state, SpotifyControlSelection selection);
    static void updateDynamicUI(Adafruit_ST7735 &tft, const SpotifyTrackState &state, SpotifyControlSelection selection, bool stateChanged);
    static void drawOfflineBanner(Adafruit_ST7735 &tft);

private:
    static void drawHeader(Adafruit_ST7735 &tft, bool isConnected);
    static void drawArtwork(Adafruit_ST7735 &tft, bool isPlaying);
